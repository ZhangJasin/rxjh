Shader "MD/Standard/LutBuilder"
{
    SubShader {
        Pass {
            ...
            // All steps will be done using ACES spaces
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                // darks
                float3 colorLutSpace = GetLutStripValue(i.uv, _Lut_Params);

                // Color grade & tonemap
                float3 col = ColorGrade(colorLutSpace);
                col = Tonemap(col);
