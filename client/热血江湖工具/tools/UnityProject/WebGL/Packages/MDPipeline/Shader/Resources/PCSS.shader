...
Shader "Hidden/PCSS"
{
    Properties
    {
        _MainLightShadowmapTexture ("", any) = "" {}
    }
    ...
    */
    ...
    {
        return UNITY_SAMPLE_SHADOW(_MainLightShadowmapTexture, coord);
    }
    ...
    */
    fixed4 frag_hard (v2f i) : SV_Target
    {
        ...
        half shadow = UNITY_SAMPLE_SHADOW(_MainLightShadowmapTexture, GET_SHADOW_COORDINATES(wpos, cascadeWeights));
