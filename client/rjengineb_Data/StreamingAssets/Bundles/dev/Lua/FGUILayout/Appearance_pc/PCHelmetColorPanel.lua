...
local PCHelmetColorPanel = class("PCHelmetColorPanel", BaseFGUILayout)

local MODEL_SCALE = 0.75

function PCHelmetColorPanel:Create()
...
function PCHelmetColorPanel:Enter()
    self:RegisterEvent()
	self:RefreshModel()
	self:InitData()
end

function PCHelmetColorPanel:InitData()
	self._targetAlp = 0.7
	self._targetColor = nil
...
function PCHelmetColorPanel:Exit()
	self:RemoveEvent()
end

function PCHelmetColorPanel:Close()
	self.super.Close(self)
end

function PCHelmetColorPanel:OnClickSureButton()
...
function PCHelmetColorPanel:RefreshModel()
...
-- 滑动条变动
function PCHelmetColorPanel:OnColorSliderChanged()
...
-- 选择颜色
function PCHelmetColorPanel:OnColorSelect(context)
...
-- 改变头发颜色
function PCHelmetColorPanel:ChangeHelmetColor()
...
function PCHelmetColorPanel:ColorRGBToHexStr(r, g, b)
...
function PCHelmetColorPanel:ClearModel()
    if self._model then
...
-- 设置旋转
function PCHelmetColorPanel:SetModelRotate(uiTouch)
    local angleX = 0
    local angleY = 0
    local angleZ = 0
    local beginX = 0
...
function PCHelmetColorPanel:RegisterEvent()
	
end

function PCHelmetColorPanel:RemoveEvent()

end

return PCHelmetColorPanel