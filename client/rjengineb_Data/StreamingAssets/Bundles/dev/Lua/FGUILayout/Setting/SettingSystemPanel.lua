...
local SettingSystemPanel = class("SettingSystemPanel", SettingPageBase)

function SettingSystemPanel:Enter()
    SettingSystemPanel.super.Enter(self)
    ...
    if not self.component then
        release_log_traceback("ERROR SettingSystemPanel component is nil. packageName:"..self._packageName)
        return
    end
...
function SettingSystemPanel:Exit()
    SL:ComponentDetach(SLDefine.SUIComponentTable.SettingSystem)

    SettingSystemPanel.super.Exit(self)
end

function SettingSystemPanel.Create()
    return SettingSystemPanel.new()
end

function SettingSystemPanel:InitData()

end

function SettingSystemPanel:Init_PolicyUI()
    -- body
...
-- 画质 -------------------------------------------------------------------------
function SettingSystemPanel:Init_Quality()
...
function SettingSystemPanel:Refresh_Quality()
...
-- 高帧率 -------------------------------------------------------------------------
function SettingSystemPanel:Init_HighFrameRate()
...
-- 垂直同步 -------------------------------------------------------------------------
function SettingSystemPanel:Init_VSyncEnable()
...
-- 省电模式 -------------------------------------------------------------------------
function SettingSystemPanel:Init_AutoECO()
...
function SettingSystemPanel:OnClickHelpEcoBtn()
    local data = {}
...
function SettingSystemPanel:Init_MsaaQuality()
...
function SettingSystemPanel:Refresh_MsaaQuality()
...
-- 同屏人数 -------------------------------------------------------------------------
function SettingSystemPanel:Init_PlayerCount()
    local min = 1
...
function SettingSystemPanel:Refresh_PlayerCount()
...
function SettingSystemPanel:OnChange_PlayerCount()
...
-- 相机距离 -------------------------------------------------------------------------
function SettingSystemPanel:Init_CameraDistance()
...
function SettingSystemPanel:OnChange_CameraDistance()
...
-- 同屏特效 ---------------------------------------------------------------------
function SettingSystemPanel:Init_FixLimit()
    local defaultDisplaySettings = C_DefaultGameSettings.PerformanceConfig[global.ModelQuality]
...
function SettingSystemPanel:OnChange_FixLimit(context)
...
-- 音乐 -------------------------------------------------------------------------
function SettingSystemPanel:Init_BGM()
...
function SettingSystemPanel:OnChange_BGMValue(context)
    local value = FGUI:GSlider_getValue(context.sender)
...
-- 音效 -------------------------------------------------------------------------
function SettingSystemPanel:Init_Sound()
...
function SettingSystemPanel:OnChange_SoundValue(context)
    local value = FGUI:GSlider_getValue(context.sender)
...
-- 礼包兑换
function SettingSystemPanel:OnClickRedeemCodeBtn(context)
    FGUI:Open("Setting", "SettingRedeemCodePanel")
end

function SettingSystemPanel:RefresPlayerInfo()
...
function SettingSystemPanel:CopyUserId(context)
...
function SettingSystemPanel:ShowPolicyContent(showUrl, paramData)
...
-- 隐私协议
function SettingSystemPanel:OnClickPrivacyPolicyBtn(context)
...
-- 儿童隐私协议
function SettingSystemPanel:OnClickChildrenPrivacyPolicyBtn(context)
...
-- 用户协议
function SettingSystemPanel:OnClickTermsOfServiceBtn(context)
...
-- 第三方共享
function SettingSystemPanel:OnClickThirdPartyDataSharingBtn(context)
...
-- 联系客服
function SettingSystemPanel:OnClickContactSupportBtn()
    SL:OpenSDKKeFu()
end
-- 注销账号
function SettingSystemPanel:OnClicknDeleteAccountBtn(context)
    local callback = function(bType, custom)
        if 1 == bType then
...
-- 切换账号
function SettingSystemPanel:OnClickSwitchCharacterBtn(context)
    local data = {}
...
-- 返回登录
function SettingSystemPanel:OnClickBackToLoginBtn(context)
    local data = {}
...
-- 打开ICP
function SettingSystemPanel:OnClickICPBtn(context)
    -- body
...
-- 脱离卡死
function SettingSystemPanel:OnClickDisengageBtn(context)
    FGUI:Close("Setting", "SettingPanel")
    FGUI:Open("OutBlock", "OutBlockPanel")
end
-- Common Function -------------------------------------------------------------------------
function SettingSystemPanel:ResetSwitch(widget, enable)
...
function SettingSystemPanel:GetComponentFormOptionItem(name)
