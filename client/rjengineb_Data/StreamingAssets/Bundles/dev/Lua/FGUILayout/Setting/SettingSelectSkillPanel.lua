...
local SettingSelectSkillPanel = class("SettingSelectSkillPanel", BaseFGUILayout)
...
function SettingSelectSkillPanel:InitData()
end

function SettingSelectSkillPanel:InitEvent()
...
function SettingSelectSkillPanel:Enter(userdata)
...
function SettingSelectSkillPanel:Exit()
	self:RemoveEvent()
end

function SettingSelectSkillPanel:OnClose()
	self.super.Close(self)
end

function SettingSelectSkillPanel:Destroy()
end

function SettingSelectSkillPanel:RegisterEvent()
end

function SettingSelectSkillPanel:RemoveEvent()
end

function SettingSelectSkillPanel:SkillListRender(idx, item)
...
function SettingSelectSkillPanel:OnSelectSkill(context)
...
function SettingSelectSkillPanel:OnClickCloseBtn()
	if self._callback then
		self._callback(-1)
	end
	self:Close()
...
return SettingSelectSkillPanel