...
function PCBagViewModelForHS:RegisterEvent()
	...
	-- SL:RegisterLUAEvent(LUA_EVENT_BAG_RECYCLE_SELECT, "PCBagViewModelForHS",  handler(self,self.RecycleSelectCell))
...
function PCBagViewModelForHS:UnRegisterEvent()
	...
	-- SL:UnRegisterLUAEvent(LUA_EVENT_BAG_RECYCLE_SELECT, "PCBagViewModelForHS")
