...
function PCBagViewModel:RegisterEvent()
	...
	SL:RegisterLUAEvent(LUA_EVENT_BAG_ITEM_CHANGE_DELAY, "PCBagViewModel",  handler(self,self.RecycleSelectCell))
...
function PCBagViewModel:UnRegisterEvent()
	...
	SL:UnRegisterLUAEvent(LUA_EVENT_BAG_ITEM_CHANGE_DELAY, "PCBagViewModel")
