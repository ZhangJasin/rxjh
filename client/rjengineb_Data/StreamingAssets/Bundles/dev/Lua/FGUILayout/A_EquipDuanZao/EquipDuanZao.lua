...
local equippos3 = { [5]=1, [3]=2, [8]=3, [9]=4, [51]=5, [15]=6, [19]=7, [22]=8,[53]=9 }        -- 装备位置对应表内id映射  当前整个系统多个子页签因共用一套装备所以公用这个方法。如果有大的改变可向equippos2自行优化，服务端也要改
...
function EquipDuanZao:addequipshow()
    ...
    if self.qhequipMakeIndex ~= 0 then
        ...
        elseif self.pageControlle.selectedIndex == 3 and itemData then
            for i = 1, #itemData.Values do
