...
local PCSettingCheckPickUpPanel = class("PCSettingCheckPickUpPanel", BaseFGUILayout)
...
function PCSettingCheckPickUpPanel:InitData()
	-- 关闭按钮
...
function PCSettingCheckPickUpPanel:Refresh(userdata)
	self:RegisterEvent()
...
function PCSettingCheckPickUpPanel:Exit()
	self:RemoveEvent()
end

function PCSettingCheckPickUpPanel:OnClose()
	self.super.Close(self)
end

function PCSettingCheckPickUpPanel:Destroy()
end

function PCSettingCheckPickUpPanel:RegisterEvent()
end

function PCSettingCheckPickUpPanel:RemoveEvent()
end

function PCSettingCheckPickUpPanel:RefreshPanel()
...
function PCSettingCheckPickUpPanel:OnShowDropItemSwitchChange(context)
...
function PCSettingCheckPickUpPanel:OnPickUpSwitchChange(context)
	local idx = FGUI:GetIntData(context.sender)
	local info = self._infoTb[idx]
	local enable = FGUI:GButton_getSelected(context.sender)
...
return PCSettingCheckPickUpPanel