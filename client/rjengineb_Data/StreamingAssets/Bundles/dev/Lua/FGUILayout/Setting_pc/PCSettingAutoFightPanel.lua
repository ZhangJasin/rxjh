...
-- function PCSettingAutoFightPanel:RefreshJobSkills()
--     -- 职业技能
...
-- -- 当方案名改变
-- function PCSettingAutoFightPanel:OnSchemeNameChanged(context)
...
-- -- 选择方案
-- function PCSettingAutoFightPanel:OnSelectSchemeChanged(context)
--     local idx = FGUI:GComboBox_getSelectedIndex(context.sender)
...
-- -- 选择释放模式
-- function PCSettingAutoFightPanel:OnSelectReleaseModelChanged(context)
--     local idx = FGUI:GComboBox_getSelectedIndex(context.sender)    
...
-- -- 职业武功列表刷新
-- function PCSettingAutoFightPanel:JobSkillListRender(idx, item)
...
-- -- 点击职业技能
-- function PCSettingAutoFightPanel:OnClickJobSkill(context)
...
--     FGUI:Open("Setting_pc", "PCSettingSelectSkillPanel", data)
-- end
