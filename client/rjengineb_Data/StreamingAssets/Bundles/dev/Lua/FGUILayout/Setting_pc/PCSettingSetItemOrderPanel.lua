...
local PCSettingSetItemOrderPanel = class("PCSettingSetItemOrderPanel", BaseFGUILayout)
...
function PCSettingSetItemOrderPanel:InitData()
...
function PCSettingSetItemOrderPanel:InitEvent()
...
function PCSettingSetItemOrderPanel:Enter(userdata)
...
function PCSettingSetItemOrderPanel:Exit()
    self:RemoveEvent()
end

function PCSettingSetItemOrderPanel:Close()
...
function PCSettingSetItemOrderPanel:Destroy()
end

function PCSettingSetItemOrderPanel:RegisterEvent()
end

function PCSettingSetItemOrderPanel:RemoveEvent()
end

function PCSettingSetItemOrderPanel:SkillListRender(index, item)
...
function PCSettingSetItemOrderPanel:OnSelectSkill(context)
...
function PCSettingSetItemOrderPanel:SetSelect(idx)
...
function PCSettingSetItemOrderPanel:OnDragStart(context)
...
function PCSettingSetItemOrderPanel:OnDragMove(context)
    FGUI:EventContext_stopPropagation(context)
...
function PCSettingSetItemOrderPanel:OnDragEnd(context)
    FGUI:EventContext_stopPropagation(context)
...
return PCSettingSetItemOrderPanel
