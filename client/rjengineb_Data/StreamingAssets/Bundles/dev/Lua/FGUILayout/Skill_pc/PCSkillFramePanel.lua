...
local PCSkillFramePanel = class("PCSkillFramePanel", BaseFGUILayout)
...
function PCSkillFramePanel:Exit()
...
function PCSkillFramePanel:Close()
	self.super.Close(self)
end

function PCSkillFramePanel:InitData()
	self._selPage = nil
end

function PCSkillFramePanel:InitEvent()
	FGUI:setOnClickEvent(self._ui.btn_close, handler(self, self.Close))
end

function PCSkillFramePanel:Enter(page)
	------------交易行截图begin----------
...
function PCSkillFramePanel:InitPage()
...
function PCSkillFramePanel:SelectPage(index)
	...
	if not pageData.obj then 
		pageData.obj = FGUI:CreateObject(self._ui.Node_Content, "Skill_pc", pageData.componentName, true)
	end
