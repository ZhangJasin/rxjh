...
local TeamInvitePanel = class("TeamInvitePanel", BaseFGUILayout)
...
function TeamInvitePanel:Create()
...
function TeamInvitePanel:Close()
	self.super.Close(self)
end

function TeamInvitePanel:InitData()
    self._selPage = 1
    self._members = {}
    self._selUID = nil
...
function TeamInvitePanel:InitEvent()
...
function TeamInvitePanel:Enter()
    self:SelectPage(1)
    self:RegisterEvent()
end

function TeamInvitePanel:Exit()
    self._requestGuild = false
    self._requestFriend = false
	self:RemoveEvent()
end

function TeamInvitePanel:PageRenderer(idx, item)
    local index = idx + 1
...
function TeamInvitePanel:OnClickPage(eventData)
...
function TeamInvitePanel:SelectPage(index)
...
function TeamInvitePanel:OnUpdateTeamMemberList(index)
...
local AVATOR_DATA = {}
function TeamInvitePanel:InviteListRenderer(idx, item)
...
-----------------------------------注册事件--------------------------------------
function TeamInvitePanel:RegisterEvent()
    SL:RegisterLUAEvent(LUA_EVENT_TEAM_NEAR_PLAYER_UPDATE, "TeamInvitePanel", handler(self, self.OnUpdateTeamMemberList))
end

function TeamInvitePanel:RemoveEvent()
    SL:UnRegisterLUAEvent(LUA_EVENT_TEAM_NEAR_PLAYER_UPDATE, "TeamInvitePanel")
end
