...
local PCTipLastJiShouPanel = class("PCTipLastJiShouPanel", BaseFGUILayout)
...
function PCTipLastJiShouPanel:InitData()
end

function PCTipLastJiShouPanel:GetAllFGuiData()
...
function PCTipLastJiShouPanel:InitOnClickEvent()
...
function PCTipLastJiShouPanel:BtnCancelClicked()
    self:OnClose()
end

function PCTipLastJiShouPanel:RefreshUI()
...
function PCTipLastJiShouPanel:RegisterEvent()
    SL:RegisterLUAEvent(LUA_EVENT_MY_AUCTION_ADD_SELL_SUCC, "PCTipLastJiShouPanel", handler(self, self.OnClose))
end

function PCTipLastJiShouPanel:RemoveEvent()
    SL:UnRegisterLUAEvent(LUA_EVENT_MY_AUCTION_ADD_SELL_SUCC, "PCTipLastJiShouPanel")
end

function PCTipLastJiShouPanel:OnClose()
    self.super.Close(self)
end

function PCTipLastJiShouPanel:Exit()
    self:RemoveEvent()
end

return PCTipLastJiShouPanel