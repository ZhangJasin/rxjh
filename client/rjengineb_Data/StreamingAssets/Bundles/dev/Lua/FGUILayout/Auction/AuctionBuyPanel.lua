...
function AuctionBuyPanel:InitUI()
    ...
    for _key,_value in ipairs(self._treeData.tree) do
        ...
        local parent = FGUI:GTreeNode_Create("ui://5i0v372frxpmj",isHasChild)
        ...
        if _value and isHasChild then
            for _nPage,_value_ in pairs(_value) do
                local child = FGUI:GTreeNode_Create("ui://5i0v372fmqpjh",false)
...
function AuctionBuyPanel:PlayerLoadingActionByTime(time)
...
function AuctionBuyPanel:RegisterEvent()
    ...
    SL:RegisterLUAEvent(LUA_EVENT_MY_AUCTION_LOADING_UPDATE, "AuctionBuyPanel", handler(self, self.PlayerLoadingActionByTime))
end
